...
description: "Decision record documenting the adoption of local Graphify AST parsing over external vector embedding services."
...
Adopt local, executable AST tools (`graphify update .`, `pyreverse`, Python `ast`) as the primary knowledge extraction engine for generating OpenWiki software architecture documentation.
