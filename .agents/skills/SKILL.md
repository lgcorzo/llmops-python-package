Here is the updated, production-ready Agent Skill prompt (`SKILL.md`). It explicitly enforces **relative paths only** (banning absolute paths to prevent portability breakages), leverages **OpenWiki** for narrative/general OKF documentation structure, and uses **Pyreverse / Graphify** for deterministic, AST-grounded technical class topology and code relationships.

---

### `.agents/skills/okf-professional-documenter/SKILL.md`
